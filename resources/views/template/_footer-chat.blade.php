<footer class="section-p3">
        <div class="col">
            <img src="img/searchwork logo 3.png" class="logo" alt="">
            <h4>contact</h4>
        ...
        <div class="foot-category">
            ...
            <a href="explore.php"><h4>Web Development</h4></a>
            <a href="explore.php"><h4>Business</h4></a>
            <a href="explore.php"><h4>Music & Audio</h4></a>
        </div>
</footer>
